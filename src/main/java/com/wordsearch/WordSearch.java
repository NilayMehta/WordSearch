...
//        System.out.println("DAWG Node count After Optimization: " + dawg.getNodeCount());
        ...
        endTime = System.currentTimeMillis();
        duration = (endTime - startTime);
        System.out.println("DESERIALIZE FROM GZ DURATION: " + (float) duration /1000 + " seconds");

        startTime = System.currentTimeMillis();
        dawg = deserializeDawg();
        endTime = System.currentTimeMillis();
        duration = (endTime - startTime);
        System.out.println("DESERIALIZE FROM SER DURATION: " + (float) duration /1000 + " seconds");
